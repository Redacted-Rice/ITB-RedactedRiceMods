# Legendary Pilot Level Up Skills
Rare, powerful pilot level up skills that can only appear in the second skill slot,
once per run, and at half as often (by default). Boost your pilots to the next
level!

Enable and disable individual skills in the CPLUS+ Modify Pilot Abilities Menu. Or if
you want to go crazy, you can configure them to be regular skills O.O
...
| Per‑pilot chance | 3 pilots | 4 pilots | 5 pilots |
|------------------|----------|----------|----------|
| 10%              | 27.1%    | 34.4%    | 41.0%    |
| 15%              | 38.6%    | 47.8%    | 55.9%    |
| 20%              | 48.8%    | 59.0%    | 67.2%    |
...
Or to get 50% chance:
| Number of pilots | Per‑pilot chance needed for 50% run chance |
|------------------|--------------------------------------------|
| 3 pilots         | 20.6%                                      |
| 4 pilots         | 15.9%                                      |
| 5 pilots         | 12.9%                                      |
...
* Redacted Rice Discord Server: https://discord.gg/CNjTVrpN4v
...
### Stats
* **Grid Hero** - +20 Grid Defense
* **Juggernaut** - +5 HP
* **Overdrive** - +2 Reactors
* **Prodigy** - +1 Reactor, +1 Move, +2 HP
