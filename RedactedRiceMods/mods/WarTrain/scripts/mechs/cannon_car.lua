...
addDirectionalAnim("wartrain_cannon_car", {
	base = {posX = -17, posY = -5},
})
addDirectionalAnim("wartrain_cannon_car_dir0", {
	base = {posX = -17, posY = -5},
	--a = {posX = -17, posY = -5},
...
addDirectionalAnim("wartrain_cannon_car_dir1", {
	base = {posX = -17, posY = -5},
	--a = {posX = -17, posY = -5},
	_broken = {posX = -17, posY = -5},
	w_broken = {posX = -17, posY = -5},
...
addDirectionalAnim("wartrain_cannon_car_dir2", {
	base = {posX = -17, posY = -5},
	--a = {posX = -17, posY = -5},
	_broken = {posX = -17, posY = -5},
	w_broken = {posX = -17, posY = -5},
...
addDirectionalAnim("wartrain_cannon_car_dir3", {
	base = {posX = -17, posY = -5},
	--a = {posX = -17, posY = -5},
	_broken = {posX = -17, posY = -5},
	w_broken = {posX = -17, posY = -5},
...
WarTrain_CannonCarMech = Pawn:new{
	Name = "Cannon Car",
	Class = "Brute",
	Health = 3,
	MoveSpeed = 0,
	Image = "wartrain_cannon_car",
