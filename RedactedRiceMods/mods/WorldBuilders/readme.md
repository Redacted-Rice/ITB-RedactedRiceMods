...
### Notes
* Minor update to fix board utils handling of a few corner cases with All Terrain skill
...
### Notes
* Reworked shielding logic for swap so it won't remove pawns shields when swapping tiles under shielded pawns
...
* ModLoader     2.9.4
* ModLoaderExt  1.21
* Memedit       1.2.1* (custom pre-release version)
