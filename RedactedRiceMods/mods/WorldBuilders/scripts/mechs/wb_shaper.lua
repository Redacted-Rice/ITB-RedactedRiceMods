...
a.wb_shaperw =        a.MechUnit:new{Image = "units/player/wb_shaper_w.png",        PosX = -22, PosY = -3 }
a.wb_shaper_broken =  a.MechUnit:new{Image = "units/player/wb_shaper_broken.png",   PosX = -21, PosY =  -9 }
a.wb_shaperw_broken = a.MechUnit:new{Image = "units/player/wb_shaper_w_broken.png", PosX = -26, PosY =  -3 }
